...
var Server = /** @class */ (function () {
    ...
    Server.prototype.loadControllers = function (controllers) {
        ...
        controllers.forEach(function (controller) {
            _this._app.use("/".concat(controller.prefix), controller.router);
        });
    };
    // Start the server
    Server.prototype.init = function () {
        var _this = this;
        this.server = this._app.listen(this.port, function () {
            console.log("Server Running @'http://localhost:".concat(_this.port, "'"));
        });
